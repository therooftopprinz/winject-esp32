...
{
    print(out,
          " udp_rx_pkt=%u udp_tx_pkt=%u udp_tx_dropped=%u udp_tx_failed=%u "
          "udp_rx_crc_err=%u udp_rx_dropped=%u tx_queue=%u rx_queue=%u\n",
          (unsigned)radio.udp_rx_pkt, (unsigned)radio.udp_tx_pkt,
          (unsigned)radio.udp_tx_dropped, (unsigned)radio.udp_tx_failed,
          (unsigned)radio.udp_rx_crc_err, (unsigned)radio.udp_rx_dropped,
          (unsigned)radio.tx_queue, (unsigned)radio.rx_queue);
}
